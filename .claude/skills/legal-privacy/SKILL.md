...
name: legal-privacy
description: >-
  Generates a GDPR/CCPA-compliant privacy policy from a product's actual data
  practices: collection inventory, legal-basis table, recipients, retention table,
  transfers, GDPR rights, CCPA categories, cookies. Use when drafting or auditing
  a privacy policy. Source: github.com/zubair-trabzada/ai-legal-claude
---
